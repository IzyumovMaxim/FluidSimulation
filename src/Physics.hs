...
-- | Type for spacial grid
type OptimizedGrid = IM.IntMap [Int]
...
-- | Get neighbor indices using grid
...
-- | Combine all forces for a particle
...
-- | Update single particle with force computation
...
-- | Kernels with reduced computation
